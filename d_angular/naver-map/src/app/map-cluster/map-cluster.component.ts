...
import { MarkerClusteringService } from './marker-clustering.service';
// import { MarkerClustering } from './MarkerClustering';
declare var naver: any;
// declare var MarkerClustering: any;
...
export class MapClusterComponent implements OnInit {
  ...
  getClustering() {
    ...
    var htmlMarker1 = {
      content: '<div style="cursor:pointer;width:40px;height:40px;line-height:42px;font-size:10px;color:white;text-align:center;font-weight:bold;background:url(../../assets/image/cluster-marker-1.png);background-size:contain;"></div>',
    },
      htmlMarker2 = {
        content: '<div style="cursor:pointer;width:40px;height:40px;line-height:42px;font-size:10px;color:white;text-align:center;font-weight:bold;background:url(../../assets/image/cluster-marker-1.png);background-size:contain;"></div>',
      },
    ...
    var markerClustering = new MarkerClustering({
      ...
      stylingFunction: function (clusterMarker, count) {
        const cluster = (clusterMarker.getElement() as HTMLElement).querySelector('div:first-child');
