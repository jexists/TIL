...
//   console.error
// )
(0, _rxjs.from)([0, 1, 2, 3, 4]).pipe((0, _operators.map)(function (x) {
  if (x === 4) throw new Error('에러');else return x;
}), (0, _operators.retry)(3)).subscribe(console.log, console.error);
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","rxjs-exception.js"], null)
//# sourceMappingURL=/rxjs-exception.4a37f328.js.map